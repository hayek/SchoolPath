                            ...
                            <div style="padding-right: 44px;">
                                ...
                                ${taskPdfs && taskPdfs.length > 0 ? `
                                    <div style="margin-top: 10px;">
                                        <strong style="color: #666; font-size: 14px; display: block; margin-bottom: 8px;">ملفات PDF:</strong>
                                        <div style="display: flex; flex-wrap: wrap; gap: 8px;">
                                            ${taskPdfs.map(pdf => `
                                                <a href="${pdf}" target="_blank" style="display: inline-flex; align-items: center; gap: 6px; color: ${taskColor}; text-decoration: none; font-size: 14px; background: ${taskColor}20; padding: 10px 14px; border-radius: 8px; font-weight: 500;">
